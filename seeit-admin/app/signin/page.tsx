...
const HIGHLIGHTS = [
  ...
  },
  {
    ...
    description: 'Moderate the content that powers customer decisions.',
  },
  {
    icon: ShieldCheck,
    title: 'Admin-only access',
    description: 'Role-gated, audit-friendly, and built for your team.',
  },
];
...
export default function SignInPage() {
  return (
    <main className="grid min-h-screen grid-cols-1 bg-background lg:grid-cols-[1.05fr_1fr]">
      {/* Marketing / brand panel — left on desktop, hidden on small */}
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[14px] text-muted-foreground">
              Sign in to manage the SeeIt platform.
            </p>
          </div>
          ...
          <div className="mt-8 rounded-xl border border-border bg-card/60 p-3.5">
            <p className="text-[12px] leading-relaxed text-muted-foreground">
              <span className="font-semibold text-foreground">Admin access only.</span>{' '}
              Customers and restaurant owners use the dedicated consumer apps.
            </p>
          </div>
        </div>
      </section>
