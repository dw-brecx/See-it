...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-background shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out flex flex-col',
  {
    variants: {
      side: {
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      'sticky bottom-0 flex flex-col-reverse gap-2 border-t border-border bg-background px-6 py-3 sm:flex-row sm:justify-end',
      className,
    )}
    {...props}
  />
