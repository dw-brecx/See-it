      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 text-[12.5px] text-red-900/80">
            Permanently removes this location plus all menu items, photos, and
            reviews tied to it. This is logged in the audit log.
          </p>
          <Button
            type="button"
            variant="outline"
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Permanently removes the location plus all menu items, photos, and
